...
<DIV style="Z-INDEX: 9999; POSITION: relative; PADDING-TOP: 0px" class=search>
    <DIV class=Navlist>
        <DIV class=lnav>
            <A onmousemove=showMenu() href="#"><IMG src="/static/image/311top_142.gif"></A>
    ...
    <FORM id=searchForm method=get name=searchForm action=/fenlei.php>
        ...
        <SPAN>&nbsp;&nbsp;&nbsp;&nbsp;<STRONG>热门搜索</STRONG>：
            <A href="#">金雅莉安</A><A href="#"> 超氧离子水生成器</A><A href="#"> O度</A>
        </SPAN>
        <SPAN class=jiesuan>
...
<DIV class=" box">
    <DIV class=boxL>
       ...
       &nbsp;&nbsp;&nbsp; 共同打造中国最大的品牌特惠分期商城</p>--></DIV>
        <UL>
            ...
            <LI>
                <STRONG>直付、到付任选</STRONG><BR>
                银联首批合作商城，安全快捷无需开通网银；分期手续费超低，多种分期支付方式：货到付款，支付宝，网银在线，财富通。
            </LI>
            <LI class=li2><IMG src="/static/image/login_17.gif"></LI>
    ...
    <DIV class=boxR>
                ...
                <TABLE border=0 cellSpacing=10 cellPadding=0 width=370>
                    ...
                    <TR>
                        ...
                        <TD>
                            ...
                            <INPUT id=back_act value=/member/index.php type=hidden name=back_act/>
        ...
        <DIV class=R3>
            ...
            <A href="/register"><IMG alt=新用户注册 src="/static/image/22_07.gif"></A></DIV>
    </DIV>
    <DIV class=clear></DIV>
</DIV><!--内容结束-->
