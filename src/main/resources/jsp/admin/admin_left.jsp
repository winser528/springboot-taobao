        ...
        <td width="182" valign="top">
            <div id="container">
                ...
                <div class="content">
                    ...
                    <ul class="MM">
                        <li><a href="user_show" target="main">查看用户</a></li>
                    </ul>
                </div>
                <h1 class="type"><a href="javascript:void(0)">标题管理</a></h1>
                <div class="content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="/static/admin/images/menu_topline.gif" width="182" height="5"/></td>
                    ...
                    <ul class="MM">
                        <li><a href="/admin/category_show" target="main">分类显示</a></li>
                        <li><a href="/admin/category_add" target="main">添加分类</a></li>
                    </ul>
                </div>
                ...
                <div class="content">
                    ...
                    <ul class="MM">
                        <li><a href="wares_add" target="main">添加商品</a></li>
                        <li><a href="wares_show" target="main">商品显示</a></li>
                    </ul>
                </div>
                <h1 class="type"><a href="javascript:void(0)">管理留言</a></h1>
                <div class="content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="/static/admin/images/menu_topline.gif" width="182" height="5"/></td>
                    ...
                    <ul class="MM">
                        <li><a href="http://www.865171.cn" target="main">查看留言</a></li>
            ...
            <div class="content">
                ...
                <ul class="MM">
                    <li><a href="admintitle.html" target="main">管理设置</a></li>
